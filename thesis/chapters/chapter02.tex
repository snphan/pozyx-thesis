...
The current system presents an opportunity for proactive and preventative medicine through the use of in-home monitoring. Data obtained through monitoring can be used to track functional decline. With this information, older adults, along with their clinician, can plan early interventions and prevent future incidents and hospitalization. To better understand the role of in-home monitoring, the challenges that older adults may face as they age must be understood. Accordingly, the next section will be organized as follows for each common disease or condition from aging that affects ADLs: first, an overview of the disease or condition along with its prevalence and symptoms; next, current assessment tools for these conditions will discussed; finally, current attempts at in-home monitoring for ADLs will be investigated as well as what data and how the data is being used.
...
\subsubsection{Assessment and Management}
\subsubsection{In-Home Monitoring}
