...
To this end, the IADL of cooking or meal preparation presents an opportunity to monitor the quality or performance of an older adult wanting to age-in-place. Cooking is a "cognitive complex task, which requires multiple steps" \cite{sikkes_qualitative_2014} and coordination between physical and cognitive functionality. One of the most impacted IADLs after traumatic brain injury (TBI) is cooking \cite{dubuc_perceived_2019}. Additionally, cooking is "essential for independent living" \cite{dubuc_perceived_2019} and focus group interviews with stakeholders for a smart-home city project revealed that being able to "prepare my own meals" was ranked as one of the highest needs for adults with TBI \cite{levasseur_identifying_2016}. There are also safety concern with preparation of a hot meal and it poses risks such as "fires [or] burns" \cite{dubuc_perceived_2019} which monitoring may have a role in preventing. 
