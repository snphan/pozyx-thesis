...
\begin{table}[ht]
    ...
    \begin{tabular}[pos]{ c c c c c }
        \hline
        \textbf{Name} & \textbf{ADL Category}& \textbf{Condition} & \textbf{Method} & \textbf{Length} \\
        \hline
        Barthel Index & BADL & N/A & Self-Report, Caregiver Questionnaire, Observation of day-to-day & 2-5 Minutes \cite{staff_original_2008} \\
        \hline 
    \end{tabular}
\end{table}
