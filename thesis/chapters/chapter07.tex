...
\begin{figure}[ht]
    ...
    \caption{Duration Continuous Repetitive actions by disabilities. The disabilities are AB=Able-Bodied, OE=One-eyed, KG=Knitted Gloves, and EG=Electrical Gloves}
...
\begin{figure}[ht]
    ...
    \caption{Duration One-Time actions by disabilities. The disabilities are AB=Able-Bodied, OE=One-eyed, KG=Knitted Gloves, and EG=Electrical Gloves}
