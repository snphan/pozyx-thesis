...
EXP_TYPES = ['EATING','SLEEP','WATCHTV','STATIONARY','STANDUP','SITDOWN','SHOWERING','TOILETING','WALK','WIPE','OPENDISHWASHER','MOP','DESKWORK','MINCE','TIESHOES','BRUSHTEETH', 'GETPLATE', 'OPENFREEZER', 'OPENFRIDGE', 'SLICETOMATO', 'WASHHANDS']
