...
EXP_TYPES = ['EATING','SLEEP','WATCHTV','STATIONARY', 'TRANSFER','SHOWERING','TOILETING','WALK','WIPE','OPENDISHWASHER','MOP','DESKWORK','MINCE','TIESHOES','BRUSHTEETH', 'GETPLATE', 'OPENFREEZER', 'OPENFRIDGE', 'SLICETOMATO', 'WASHHANDS']
