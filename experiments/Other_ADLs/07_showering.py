...
TRANSITIONS = [
    'quiet standing (Outside tub)', # 5 seconds
    'Shower', 
    'quiet standing (Outside tub)', # 5 seconds
    '5 seconds elapsed',
]
...
if __name__ == "__main__":
    data_dir = Path(__file__).resolve().parent.joinpath('data', 'SHOWERING')
    ...
    with open(data_dir.joinpath(f"SHOWERING_{participant}_A{anchor_num}_{trial}.txt"), "w+") as f:
