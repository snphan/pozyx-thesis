...
TRANSITIONS = [
    'quiet standing',
    'mince', # Right before slicing 
    'quiet standing',
    '5 seconds elapsed',
]

if __name__ == "__main__":
    data_dir = Path(__file__).resolve().parent.joinpath('data', 'MINCE')
    ...
    with open(data_dir.joinpath(f"MINCE_{participant}_A{anchor_num}_{trial}.txt"), "w+") as f:
